...
pub trait HandlerUtils {
    ...
    fn handle_show_all(&self) -> Result<Vec<Response>> {
        ...
        let params = vec![
            ...
            ("server_version_num", "160001".to_string()),
            ...
            // Additional PostgreSQL-compatible parameters
            ("allow_alter_system", "off".to_string()),
            ("archive_command", "".to_string()),
            ("archive_mode", "off".to_string()),
            ("autovacuum", "on".to_string()),
            ("autovacuum_analyze_scale_factor", "0.1".to_string()),
            ("autovacuum_analyze_threshold", "50".to_string()),
            ("autovacuum_vacuum_scale_factor", "0.2".to_string()),
            ("autovacuum_vacuum_threshold", "50".to_string()),
            ("bgwriter_delay", "200".to_string()),
            ("bgwriter_lru_maxpages", "100".to_string()),
            ("bytea_output", "hex".to_string()),
            ("checkpoint_timeout", "300".to_string()),
            ("client_min_messages", "notice".to_string()),
            ("config_file", "pgqt.conf".to_string()),
            ("data_directory", "/var/lib/pgqt".to_string()),
            ("datestyle", "ISO, MDY".to_string()),
            ("deadlock_timeout", "1000".to_string()),
            ("debug_pretty_print", "on".to_string()),
            ("debug_print_parse", "off".to_string()),
            ("debug_print_plan", "off".to_string()),
            ("debug_print_rewritten", "off".to_string()),
            ("default_text_search_config", "pg_catalog.english".to_string()),
            ("dynamic_shared_memory_type", "posix".to_string()),
            ("effective_cache_size", "4GB".to_string()),
            ("enable_bitmapscan", "on".to_string()),
            ("enable_hashagg", "on".to_string()),
            ("enable_hashjoin", "on".to_string()),
            ("enable_indexscan", "on".to_string()),
            ("enable_material", "on".to_string()),
            ("enable_mergejoin", "on".to_string()),
            ("enable_nestloop", "on".to_string()),
            ("enable_seqscan", "on".to_string()),
            ("enable_sort", "on".to_string()),
            ("enable_tidscan", "on".to_string()),
            ("escape_string_warning", "on".to_string()),
            ("extra_float_digits", "1".to_string()),
            ("fsync", "on".to_string()),
            ("full_page_writes", "on".to_string()),
            ("geqo", "on".to_string()),
            ("geqo_effort", "5".to_string()),
            ("geqo_generations", "0".to_string()),
            ("geqo_pool_size", "0".to_string()),
            ("geqo_selection_bias", "2".to_string()),
            ("geqo_threshold", "12".to_string()),
            ("hba_file", "pg_hba.conf".to_string()),
            ("hot_standby", "off".to_string()),
            ("hot_standby_feedback", "off".to_string()),
            ("ident_file", "pg_ident.conf".to_string()),
            ("integer_datetimes", "on".to_string()),
            ("intervalstyle", "postgres".to_string()),
            ("jit", "off".to_string()),
            ("krb_caseins_users", "off".to_string()),
            ...
            ("log_autovacuum_min_duration", "-1".to_string()),
            ("log_checkpoints", "off".to_string()),
            ("log_connections", "off".to_string()),
            ("log_destination", "stderr".to_string()),
            ("log_disconnections", "off".to_string()),
            ("log_duration", "off".to_string()),
            ("log_executor_stats", "off".to_string()),
            ("log_hostname", "off".to_string()),
            ("log_line_prefix", "%m [%p] ".to_string()),
            ("log_lock_waits", "off".to_string()),
            ("log_min_duration_statement", "-1".to_string()),
            ("log_min_error_statement", "error".to_string()),
            ("log_min_messages", "warning".to_string()),
            ("log_parser_stats", "off".to_string()),
            ("log_planner_stats", "off".to_string()),
            ("log_replication_commands", "off".to_string()),
            ("log_rotation_age", "1440".to_string()),
            ("log_rotation_size", "10240".to_string()),
            ("log_statement", "none".to_string()),
            ("log_statement_stats", "off".to_string()),
            ("log_temp_files", "-1".to_string()),
            ("log_timezone", "UTC".to_string()),
            ("log_truncate_on_rotation", "off".to_string()),
            ("logging_collector", "off".to_string()),
            ("max_files_per_process", "1000".to_string()),
            ("max_function_args", "100".to_string()),
            ("max_identifier_length", "63".to_string()),
            ("max_index_keys", "32".to_string()),
            ("max_locks_per_transaction", "64".to_string()),
            ("max_pred_locks_per_transaction", "64".to_string()),
            ("max_prepared_transactions", "0".to_string()),
            ("max_replication_slots", "10".to_string()),
            ("max_stack_depth", "2MB".to_string()),
            ("max_standby_archive_delay", "30000".to_string()),
            ("max_standby_streaming_delay", "30000".to_string()),
            ("max_wal_senders", "10".to_string()),
            ("max_worker_processes", "8".to_string()),
            ("password_encryption", "scram-sha-256".to_string()),
            ("port", "5432".to_string()),
            ("quote_all_identifiers", "off".to_string()),
            ("restart_after_crash", "on".to_string()),
            ("session_replication_role", "origin".to_string()),
            ("ssl", "off".to_string()),
            ("ssl_ca_file", "".to_string()),
            ("ssl_cert_file", "server.crt".to_string()),
            ("ssl_crl_file", "".to_string()),
            ("ssl_key_file", "server.key".to_string()),
            ("ssl_prefer_server_ciphers", "on".to_string()),
            ("standard_conforming_strings", "on".to_string()),
            ("superuser_reserved_connections", "3".to_string()),
            ("synchronize_seqscans", "on".to_string()),
            ("synchronous_commit", "on".to_string()),
            ("tcp_keepalives_count", "9".to_string()),
            ("tcp_keepalives_idle", "7200".to_string()),
            ("tcp_keepalives_interval", "75".to_string()),
            ("temp_buffers", "8MB".to_string()),
            ("timezone_abbreviations", "Default".to_string()),
            ("track_activities", "on".to_string()),
            ("track_activity_query_size", "1024".to_string()),
            ("track_commit_timestamp", "off".to_string()),
            ("track_counts", "on".to_string()),
            ("track_functions", "none".to_string()),
            ("track_io_timing", "off".to_string()),
            ("unix_socket_directories", "/tmp".to_string()),
            ("unix_socket_group", "".to_string()),
            ("unix_socket_permissions", "0777".to_string()),
            ("update_process_title", "on".to_string()),
            ("vacuum_cost_delay", "0".to_string()),
            ("vacuum_cost_limit", "200".to_string()),
            ("vacuum_cost_page_dirty", "20".to_string()),
            ("vacuum_cost_page_hit", "1".to_string()),
            ("vacuum_cost_page_miss", "10".to_string()),
            ("vacuum_defer_cleanup_age", "0".to_string()),
            ("vacuum_freeze_min_age", "50000000".to_string()),
            ("vacuum_freeze_table_age", "150000000".to_string()),
            ("wal_block_size", "8192".to_string()),
            ("wal_keep_segments", "0".to_string()),
            ("wal_level", "replica".to_string()),
            ("wal_log_hints", "off".to_string()),
            ("wal_receiver_status_interval", "10".to_string()),
            ("wal_receiver_timeout", "60000".to_string()),
            ("wal_segment_size", "16MB".to_string()),
            ("wal_sender_timeout", "60000".to_string()),
            ("wal_sync_method", "fdatasync".to_string()),
            ("wal_writer_delay", "200".to_string()),
            ("wal_writer_flush_after", "128".to_string()),
            ("xmlbinary", "base64".to_string()),
